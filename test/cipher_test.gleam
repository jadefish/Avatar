...
pub fn new_seed_test() {
  cipher.seed(-10) |> should.be_error()
  cipher.seed(0) |> should.be_error()
  cipher.seed(10) |> should.be_ok()
}

pub fn new_version_test() {
  cipher.version(-1, -1, -1, -1) |> should.be_error()
  cipher.version(0, 0, 0, 0) |> should.be_error()
  cipher.version(1, 0, 0, 0) |> should.be_ok()
  cipher.version(7, 0, 62, 0) |> should.be_ok()
}
